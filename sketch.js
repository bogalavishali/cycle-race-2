...
var obstacleImg1,obstacleImg,obstacleImg3;
var gameOverImg;
var restartImg;
...
function preload(){
  ...
  obstacleImg1 = loadAnimation("images/obstacle1.png","images/opponent2.png","images/opponent3.png");
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    function reset();
    restartImg.addAnimation("restart",restartImg);
